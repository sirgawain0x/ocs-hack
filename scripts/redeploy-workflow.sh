...
echo "   2. Monitor logs: cre workflow logs weekly-prize-distribution --target staging-settings"
echo "   3. Check status: cre workflow status weekly-prize-distribution --target staging-settings"
echo ""
