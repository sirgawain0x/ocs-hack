...
async function main() {
  ...
  try {
    ...
    if (currentTimestamp && currentSession.startTime && currentTimestamp < currentSession.startTime) {
      console.log("❌ Session not started yet");
    }
    
    if (currentTimestamp && currentSession.endTime && currentTimestamp > currentSession.endTime) {
