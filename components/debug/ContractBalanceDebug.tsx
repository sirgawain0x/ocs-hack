...
export default function ContractBalanceDebug() {
  ...
  const getDebugInfo = () => {
    const info = {
      ...
      contract: {
        address: process.env.NEXT_PUBLIC_TRIVIA_CONTRACT_ADDRESS || '0xfF52Ed1DEb46C197aD7fce9DEC93ff9e987f8dB6',
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-4 bg-blue-50 rounded-lg">
          ...
          <div className="space-y-1 text-sm">
            <div><strong>Contract Address:</strong> {process.env.NEXT_PUBLIC_TRIVIA_CONTRACT_ADDRESS || '0xfF52Ed1DEb46C197aD7fce9DEC93ff9e987f8dB6'}</div>
